...
class SessionTerminationManager:
    ...
    def create_user_terminate_session(self, user_ids: List[str], user_logins: List[str], extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> SessionTerminationMessage:
        """
    ...
    def create_group_terminate_session(self, group_ids: List[str], extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> SessionTerminationMessage:
        """
