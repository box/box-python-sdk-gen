...
class SearchManager:
    ...
    def get_metadata_query_indices(self, scope: GetMetadataQueryIndicesScopeArg, template_key: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> MetadataQueryIndices:
        """
