...
class GetSearchOptionsArg(BaseObject):
    def __init__(self, query: Union[None, str] = None, scope: Union[None, GetSearchOptionsArgScopeField] = None, file_extensions: Union[None, str] = None, created_at_range: Union[None, str] = None, updated_at_range: Union[None, str] = None, size_range: Union[None, str] = None, owner_user_ids: Union[None, str] = None, recent_updater_user_ids: Union[None, str] = None, ancestor_folder_ids: Union[None, str] = None, content_types: Union[None, str] = None, type: Union[None, GetSearchOptionsArgTypeField] = None, trash_content: Union[None, GetSearchOptionsArgTrashContentField] = None, mdfilters: Union[None, str] = None, sort: Union[None, GetSearchOptionsArgSortField] = None, direction: Union[None, GetSearchOptionsArgDirectionField] = None, limit: Union[None, int] = None, include_recent_shared_links: Union[None, bool] = None, fields: Union[None, str] = None, offset: Union[None, int] = None, deleted_user_ids: Union[None, str] = None, deleted_at_range: Union[None, str] = None, **kwargs):
        ...
        :param file_extensions: Limits the search results to any files that match any of the provided
            ...
            without the dots.
        :type file_extensions: Union[None, str], optional
        ...
        :type created_at_range: Union[None, str], optional
        :param updated_at_range: Limits the search results to any items updated within
            ...
            If the end date is omitted (`2014-05-15T13:35:01-07:00,`) the
            current date will be used as the end date instead.
        :type updated_at_range: Union[None, str], optional
        ...
        :type size_range: Union[None, str], optional
        :param owner_user_ids: Limits the search results to any items that are owned
            ...
            support team.
        :type owner_user_ids: Union[None, str], optional
        ...
        :type recent_updater_user_ids: Union[None, str], optional
        :param ancestor_folder_ids: Limits the search results to items within the given
            ...
            `enterprise_content` scope parameter which can be requested with our
            support team.
        :type ancestor_folder_ids: Union[None, str], optional
        :param content_types: Limits the search results to any items that match the search query
            ...
            * `tags` - Any tags that are applied to an item, as defined by its
               `tags` field.
        :type content_types: Union[None, str], optional
        ...
        :param trash_content: Determines if the search should look in the trash for items.
            ...
            * `non_trashed_only` - Only searches for items currently not in
              the trash
        :type trash_content: Union[None, GetSearchOptionsArgTrashContentField], optional
        ...
        :type include_recent_shared_links: Union[None, bool], optional
