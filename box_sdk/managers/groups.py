...
class GroupsManager:
    ...
    def get_groups(self, filter_term: Optional[str] = None, fields: Optional[str] = None, limit: Optional[int] = None, offset: Optional[int] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> Groups:
        """
    ...
    def get_group_by_id(self, group_id: str, fields: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> GroupFull:
        """
    ...
    def update_group_by_id(self, group_id: str, name: Optional[str] = None, provenance: Optional[str] = None, external_sync_identifier: Optional[str] = None, description: Optional[str] = None, invitability_level: Optional[UpdateGroupByIdInvitabilityLevelArg] = None, member_viewability_level: Optional[UpdateGroupByIdMemberViewabilityLevelArg] = None, fields: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> GroupFull:
        ...
        return GroupFull.from_dict(json.loads(response.text))
    def delete_group_by_id(self, group_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> None:
        """
