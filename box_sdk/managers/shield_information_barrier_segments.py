...
class ShieldInformationBarrierSegmentsManager:
    ...
    def get_shield_information_barrier_segment_by_id(self, shield_information_barrier_segment_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> ShieldInformationBarrierSegment:
        """
    ...
    def update_shield_information_barrier_segment_by_id(self, shield_information_barrier_segment_id: str, name: Optional[str] = None, description: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> ShieldInformationBarrierSegment:
        """
        ...
        return ShieldInformationBarrierSegment.from_dict(json.loads(response.text))
    def delete_shield_information_barrier_segment_by_id(self, shield_information_barrier_segment_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> None:
        """
        ...
        return None
    def get_shield_information_barrier_segments(self, shield_information_barrier_id: str, marker: Optional[str] = None, limit: Optional[int] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> None:
        """
        ...
        return None
    def create_shield_information_barrier_segment(self, shield_information_barrier: ShieldInformationBarrierBase, name: str, description: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> ShieldInformationBarrierSegment:
        """
