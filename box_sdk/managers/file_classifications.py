...
class CreateFileMetadataEnterpriseSecurityClassification6VmVochwUWoRequestBodyArg(BaseObject):
...
class FileClassificationsManager(BaseObject):
    ...
    def create_file_metadata_enterprise_security_classification_6_vm_vochw_u_wo(self, file_id: str, request_body: CreateFileMetadataEnterpriseSecurityClassification6VmVochwUWoRequestBodyArg) -> Classification:
        """
        ...
        return Classification.from_dict(json.loads(response.text))
    def delete_file_metadata_enterprise_security_classification_6_vm_vochw_u_wo(self, file_id: str):
        """
