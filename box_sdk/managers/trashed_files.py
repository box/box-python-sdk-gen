...
class TrashedFilesManager:
    ...
    def restore_file_from_trash(self, file_id: str, name: Optional[str] = None, parent: Optional[RestoreFileFromTrashParentArg] = None, fields: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> TrashFileRestored:
        """
    ...
    def get_file_trash(self, file_id: str, fields: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> TrashFile:
        """
    ...
    def delete_file_trash(self, file_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> None:
        """
