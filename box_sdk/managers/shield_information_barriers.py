...
class ShieldInformationBarriersManager:
    ...
    def get_shield_information_barrier_by_id(self, shield_information_barrier_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> ShieldInformationBarrier:
        """
    ...
    def create_shield_information_barrier_change_status(self, id: str, status: CreateShieldInformationBarrierChangeStatusStatusArg, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> ShieldInformationBarrier:
        """
        ...
        return ShieldInformationBarrier.from_dict(json.loads(response.text))
    def get_shield_information_barriers(self, marker: Optional[str] = None, limit: Optional[int] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> None:
        """
