...
class SignTemplatesManager:
    ...
    def get_sign_templates(self, marker: Optional[str] = None, limit: Optional[int] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> SignTemplates:
        """
    ...
    def get_sign_template_by_id(self, template_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> SignTemplate:
        """
