...
class LegalHoldPoliciesManager:
    ...
    def get_legal_hold_policies(self, policy_name: Optional[str] = None, fields: Optional[str] = None, marker: Optional[str] = None, limit: Optional[int] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> LegalHoldPolicies:
        """
    ...
    def create_legal_hold_policy(self, policy_name: str, description: Optional[str] = None, filter_started_at: Optional[str] = None, filter_ended_at: Optional[str] = None, is_ongoing: Optional[bool] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> LegalHoldPolicy:
        """
    ...
    def get_legal_hold_policy_by_id(self, legal_hold_policy_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> LegalHoldPolicy:
        """
        ...
        return LegalHoldPolicy.from_dict(json.loads(response.text))
    def update_legal_hold_policy_by_id(self, legal_hold_policy_id: str, policy_name: Optional[str] = None, description: Optional[str] = None, release_notes: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> LegalHoldPolicy:
        """
        ...
        return LegalHoldPolicy.from_dict(json.loads(response.text))
    def delete_legal_hold_policy_by_id(self, legal_hold_policy_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> None:
        """
