...
class ShieldInformationBarrierSegmentMembersManager:
    ...
    def get_shield_information_barrier_segment_member_by_id(self, shield_information_barrier_segment_member_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> ShieldInformationBarrierSegmentMember:
        """
    ...
    def delete_shield_information_barrier_segment_member_by_id(self, shield_information_barrier_segment_member_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> None:
        """
        ...
        return None
    def get_shield_information_barrier_segment_members(self, shield_information_barrier_segment_id: str, marker: Optional[str] = None, limit: Optional[int] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> None:
        """
        ...
        return None
    def create_shield_information_barrier_segment_member(self, shield_information_barrier_segment: CreateShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentArg, user: UserBase, type: Optional[CreateShieldInformationBarrierSegmentMemberTypeArg] = None, shield_information_barrier: Optional[ShieldInformationBarrierBase] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> ShieldInformationBarrierSegmentMember:
        """
