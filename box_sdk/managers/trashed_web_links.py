...
class TrashedWebLinksManager:
    ...
    def create_web_link_by_id(self, web_link_id: str, name: Optional[str] = None, parent: Optional[CreateWebLinkByIdParentArg] = None, fields: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> TrashWebLinkRestored:
        """
    ...
    def get_web_link_trash(self, web_link_id: str, fields: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> TrashWebLink:
        """
    ...
    def delete_web_link_trash(self, web_link_id: str, extra_headers: Optional[Dict[str, Optional[str]]] = {}) -> None:
        """
