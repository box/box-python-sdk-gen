...
class AiAgentAskResponseTypeField(str, Enum):
    AI_AGENT_ASK = 'ai_agent_ask'


class AiAgentAskResponse(BaseObject):
    _discriminator = 'type', {'ai_agent_ask'}

    def __init__(
        self,
        *,
        type: Optional[AiAgentAskResponseTypeField] = None,
        ...
        **kwargs
        ...
        :type type: Optional[AiAgentAskResponseTypeField], optional
        """
