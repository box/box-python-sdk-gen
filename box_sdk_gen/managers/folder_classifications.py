...
class UpdateFolderMetadataEnterpriseSecurityClassificationRequestBodyArgOpField(str, Enum):
    REPLACE = 'replace'

class UpdateFolderMetadataEnterpriseSecurityClassificationRequestBodyArgPathField(str, Enum):
...
class UpdateFolderMetadataEnterpriseSecurityClassificationRequestBodyArg(BaseObject):
    def __init__(self, op: Optional[UpdateFolderMetadataEnterpriseSecurityClassificationRequestBodyArgOpField] = None, path: Optional[UpdateFolderMetadataEnterpriseSecurityClassificationRequestBodyArgPathField] = None, value: Optional[str] = None, **kwargs):
        """
        :param op: `replace`
...
class FolderClassificationsManager:
    ...
    def create_folder_metadata_enterprise_security_classification(self, folder_id: str, box_security_classification_key: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> Classification:
        ...
        if extra_headers is None:
            extra_headers = {}
        request_body: BaseObject = BaseObject(Box__Security__Classification__Key=box_security_classification_key)
        headers_map: Dict[str, str] = prepare_params({**extra_headers})
        ...
        return Classification.from_dict(json.loads(response.text))
    def update_folder_metadata_enterprise_security_classification(self, folder_id: str, request_body: List[UpdateFolderMetadataEnterpriseSecurityClassificationRequestBodyArg], extra_headers: Optional[Dict[str, Optional[str]]] = None) -> Classification:
        """
