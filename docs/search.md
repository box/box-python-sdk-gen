...
- scope `Optional[GetSearchScopeArg]`
...
- recent_updater_user_ids `Optional[str]`
...
- type `Optional[GetSearchTypeArg]`
...
- trash_content `Optional[GetSearchTrashContentArg]`
...
- sort `Optional[GetSearchSortArg]`
...
- direction `Optional[GetSearchDirectionArg]`
