...
def testGetCopyUpdateDeleteFileRequest():
    ...
    updated_file_request: FileRequest = client.file_requests.update_file_request_by_id(
        file_request_id=copied_file_request.id,
        title='updated title',
    ...
    client.file_requests.delete_file_request_by_id(
        file_request_id=updated_file_request.id
    )
    with pytest.raises(Exception):
        client.file_requests.get_file_request_by_id(
            file_request_id=updated_file_request.id
        )
